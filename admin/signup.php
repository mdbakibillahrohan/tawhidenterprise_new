...
<head>
	<title>Tawhid Enterprise Admin SignUp</title>
			...
			<div class="user_card">
				<div class="d-flex justify-content-center">
					<div class="brand_logo_container">
						<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTksvp8xP5bcVUZ8t0BC1eiCtf4QHnM-F0DPnQkqLFqBQ&s" class="brand_logo" alt="Logo">
					</div>
				</div>
				<div class="d-flex justify-content-center form_container">					
					...
					?>		
						...
						<div class="input-group mb-3">
							...
							<input type="email" name="email" class="form-control input_user" value="" placeholder="Your email" required="">
						</div>
				 	...
				 	<button style="color: white;" type="submit" name="signup" class="btn login_btn">Sign Up</button>
				   </div>
					</form>
				</div>					
				<div>								
					<div class="d-flex justify-content-center links">
						If you have an account? <a style="color: white;" href="login.php" class="ml-2">Login</a>
					</div>
				<!-- 	<div class="d-flex justify-content-center links">
