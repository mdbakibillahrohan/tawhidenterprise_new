				...
				<form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
					...
					<div class="col-50">
						...
						<div class="col-50">
							...
							<input type="text" id="zip" name="zip" value="123456" class="form-control" pattern="^[0-9]{6}(?:-[0-9]{4})?$" required>
						</div>
						</div>
					</div>
				  ...
				  <input type="checkbox" name="bkash" value="Bkash">
				  <label for="vehicle1"> Bkash Payment</label>
				  <input type="checkbox" name="bkash" value="Bkash">
				  <label for="vehicle1"> kash Payment</label>
				  <input type="checkbox" name="bkash" value="Bkash">
				  <label for="vehicle1"> Bkash Payment</label>
						...
						<input type="text" id="cname" name="cardname" value="Jhon Jack" class="form-control" pattern="^[a-zA-Z ]+$" required>
						
						<div class="form-group" id="card-number-field">
                        <label for="cardNumber">Card Number</label>
                        <input type="text" class="form-control" id="cardNumber" name="cardNumber" value="9999999999999999" required>
                    </div>
						<label for="expdate">Exp Date</label>
						<input type="text" id="expdate" name="expdate" class="form-control" pattern="^((0[1-9])|(1[0-2]))\/(\d{2})$" placeholder="12/22" value="12/22" required>
						...
						<div class="col-50">
							<div class="form-group CVV">
								...
								<input type="text" class="form-control" name="cvv" id="cvv" value="213" required>
						</div>
						</div>
					</div>
					</div>
