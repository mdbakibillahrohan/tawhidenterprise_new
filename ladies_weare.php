        ...
        <div class="row">
            ...
            <div class="col-md-3">                              
               ...
               <!--  <div class="list-group">
                    ...
                    $query = "SELECT DISTINCT(product_brand) FROM products WHERE product_status = 'Active' AND product_brand = 'M COB' ORDER BY product_id DESC";
                ...
                <div class="list-group">
                    ...
                    $query = "
                    SELECT DISTINCT(product_ram) FROM products WHERE product_status = 'Active' AND product_brand = 'M COB' ORDER BY product_ram DESC
                    ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                ...
                <div class="list-group">
                    ...
                    <?php
                    $query = "
                    SELECT DISTINCT(product_storage) FROM products WHERE product_status = 'Active' AND product_brand = 'M COB' ORDER BY product_storage DESC
                    ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
            ...
            <div class="col-md-9">
                 <strong>OSAKA M COB All Collection / Tawhid Enterprise</strong>
