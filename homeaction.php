...
if(isset($_POST["categoryhome"])){
	...
	echo "
				...
				<div id='responsive-nav'>
                    ...
                    <li><a href='mens_weare.php'>OSAKA</a></li>
                    <li><a href='mens_weare.php'>OSAKA LED</a></li>
                    <li><a href='mens_weare.php'>SURFACE PANEL</a></li>
                    <li><a href='ladies_weare.php'>OSAKA M COB Collection</a></li>
                    <li><a href='kids_weare.php'>ELIT PANEL</a></li>
                       ...
                       <div class='product-widget'>
                                <a href='product.php?p=$pro_id'> 
									...
									<div class='product-body'>
										...
										<h4 class='product-price'>$pro_price<del class='product-old-price'>$old_price</del></h4>
									</div></a>
								</div>
