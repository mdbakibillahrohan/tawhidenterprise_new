        ...
        <div class="row">
            ...
            <div class="col-md-3">                              
                ...
                <div class="list-group">
                    ...
                    $query = "
                    SELECT DISTINCT(product_ram) FROM products WHERE product_status = 'Active' AND product_brand = 'ELIT PANEL' 
                    ";
                ...
                <div class="list-group">
                    ...
                    <?php
                    $query = "
                    SELECT DISTINCT(product_storage) FROM products WHERE product_status = 'Active' AND product_brand = 'ELIT PANEL' 
                    ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
